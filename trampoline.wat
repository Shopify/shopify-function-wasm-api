(module
  ...
  ;; Read API.
  (import "shopify_function_v0.1.0" "_shopify_function_input_get" (func $lib_shopify_function_input_get (result i64)))
  ;; Exports
  ...
  ;; Re-exports
  (export "shopify_function_input_get" (func $lib_shopify_function_input_get))
)
